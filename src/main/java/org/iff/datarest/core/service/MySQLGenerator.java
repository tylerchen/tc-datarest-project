...
import org.iff.datarest.util.SqlTypeMappingHelper;
...
import static org.iff.datarest.core.model.CrudModel.BusinessModel;
import static org.iff.datarest.core.model.CrudModel.FieldModel;
import static org.iff.datarest.core.service.CrudService.ProjectTuple;
...
public class MySQLGenerator implements EventBusHelper.EventProcess {
    ...
    public static class Tuple extends org.iff.datarest.util.Tuple.Two</*0:result*/Object,
            /*1:action*/String,
