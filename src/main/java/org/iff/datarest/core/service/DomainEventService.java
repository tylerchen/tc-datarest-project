...
public class DomainEventService implements EventBusHelper.EventProcess {
    ...
    public static class Tuple<T> extends org.iff.datarest.util.Tuple.Eleven<T, String /*action*/, String /*namespace*/, String /*modelName*/, String /*queryName*/, Object /*id*/, String[] /*pathConditions*/, ProcessContext /*ctx*/, String /*queryDsl*/, Object /*params*/, DomainModel /*domainModel*/, String /*domainQueryId*/> {
        ...
        public Tuple(String action, String namespace, String modelName, String queryName, Object id, String[] pathConditions, ProcessContext ctx, String queryDsl, Object params, DomainModel domainModel, String domainQueryId) {
            super(action, namespace, modelName, queryName, id, pathConditions, ctx, queryDsl, params, domainModel, domainQueryId);
        }
