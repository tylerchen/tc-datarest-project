...
import org.iff.datarest.core.mybatis.SqlMapper;
...
public class MybatisSqlServiceImpl implements RepositoryService {
    ...
    org.iff.datarest.core.mybatis.SqlMapper sqlMapper;

    public SqlSession getSqlSession() {
        if (sqlSession == null) {
            sqlSession = InstanceFactory.getInstance(SqlSession.class);
            sqlMapper = new org.iff.datarest.core.mybatis.SqlMapper(sqlSession);
        }
        return sqlSession;
    }
    ...
    public void setSqlSession(SqlSession sqlSession) {
        ...
        this.sqlMapper = new org.iff.datarest.core.mybatis.SqlMapper(sqlSession);
    }

    public org.iff.datarest.core.mybatis.SqlMapper getSqlMapper() {
