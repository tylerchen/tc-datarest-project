...
public class DDLEventService implements EventBusHelper.EventProcess {
    ...
    public static final String EVENT_NAME = org.iff.datarest.core.service.DDLEventService.class.getSimpleName();
    ...
    public static class Tuple<T> extends org.iff.datarest.util.Tuple.Seven<
            /*0:result*/T,
            /*1:action*/String,
            /*2:namespace*/String,
            /*3:catalog*/String,
