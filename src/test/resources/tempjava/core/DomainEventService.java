...
import org.iff.datarest.core.model.DomainModel;
...
import org.iff.datarest.core.service.SystemEventService;
...
public class DomainEventService implements EventBusHelper.EventProcess {
    ...
    public static final String EVENT_NAME = org.iff.datarest.core.service.DomainEventService.class.getSimpleName();
    ...
    protected DomainModel pathParamToVariable(String namespace, String modelName, String queryName, String[] pathConditions) {
        ...
        DomainQueryModel dqm = new DomainQueryModel().init(namespace, modelName);
        {
            ...
            org.iff.datarest.core.service.SystemEventService.Tuple<DomainQueryModel> tuple = org.iff.datarest.core.service.SystemEventService.Tuple.getDomainQueryModel(dqm);
            EventBusHelper.me().syncEvent(org.iff.datarest.core.service.SystemEventService.EVENT_NAME, tuple);
        ...
        Map<String, DomainParamModel> paramMap = new HashMap<>();
        {
            ...
            org.iff.datarest.core.service.SystemEventService.Tuple<Page<DomainParamModel>> tuple = org.iff.datarest.core.service.SystemEventService.Tuple.findDomainParamModel(dpm, Page.offsetPage(0, 1000, null));
            EventBusHelper.me().syncEvent(org.iff.datarest.core.service.SystemEventService.EVENT_NAME, tuple);
    ...
    public static class Tuple<T> implements Serializable, org.iff.datarest.util.Tuple.Result {
