...
import static org.iff.datarest.util.SystemHelper.getProps;
...
public class DataSourceFactory {
    ...
    public static DataSource create(String name) {
        ...
        org.iff.datarest.core.service.DomainEventService.Tuple params = org.iff.datarest.core.service.DomainEventService.Tuple.queryOne("IFF_REST_SYSTEM", "DataSource", "getByNamespace", name);
