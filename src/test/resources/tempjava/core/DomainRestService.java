...
public class DomainRestService {
    ...
    public Page index(String namespace, String modelName, ProcessContext ctx) {
        ...
        try {
            ...
            org.iff.datarest.core.mybatis.MyBatisSqlSessionFactory.close(service);
        }
    }
    ...
    public Object create(String namespace, String modelName, ProcessContext ctx) {
        ...
        try {
            ...
            if (error != null) {
                org.iff.datarest.core.mybatis.MyBatisSqlSessionFactory.rollback(service);
            } else {
                org.iff.datarest.core.mybatis.MyBatisSqlSessionFactory.commit(service);
            }
        }
    }
